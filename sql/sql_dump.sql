...
CREATE TABLE IF NOT EXISTS `volleytrain`.`Matchfield_has_Equipment` (
  ...
  PRIMARY KEY (`Matchfield_PK_Matchfield`, `Equipment_PK_Equipment`),
...
CREATE TABLE IF NOT EXISTS `volleytrain`.`Position` (
  ...
  `Matchfield_has_Equipment_Matchfield_PK_Matchfield` INT NOT NULL,
  `Matchfield_has_Equipment_Equipment_PK_Equipment` INT NOT NULL,
  `x` FLOAT NULL,
  `y` FLOAT NULL,
  PRIMARY KEY (`PK_Position`, `Matchfield_has_Equipment_Matchfield_PK_Matchfield`, `Matchfield_has_Equipment_Equipment_PK_Equipment`),
  INDEX `fk_Position_Matchfield_has_Equipment1_idx` (`Matchfield_has_Equipment_Matchfield_PK_Matchfield` ASC, `Matchfield_has_Equipment_Equipment_PK_Equipment` ASC) VISIBLE,
  CONSTRAINT `fk_Position_Matchfield_has_Equipment1`
    FOREIGN KEY (`Matchfield_has_Equipment_Matchfield_PK_Matchfield` , `Matchfield_has_Equipment_Equipment_PK_Equipment`)
    REFERENCES `volleytrain`.`Matchfield_has_Equipment` (`Matchfield_PK_Matchfield` , `Equipment_PK_Equipment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
